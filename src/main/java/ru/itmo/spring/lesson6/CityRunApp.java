...
//            switch (choice) {
//
//                case "1" -> cityService.addCityConsole();
//                case "2" -> cityService.viewAllCitiesConsole();
//                case "3" -> cityService.findByCodeConsole();
//                case "4" -> cityService.updateCity();
//                case "5" -> cityService.deleteCity();
//
//
//                case "6" -> cityService.viewAllRegionsConsole();
//                case "7" -> cityService.addRegionConsole();
//                case "8" -> cityService.deleteRegionConsole(); // Удаление по коду
//
//                case "0" -> {
//                    System.out.println("\nВыход из программы");
//                    return;
